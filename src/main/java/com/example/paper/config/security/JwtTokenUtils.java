package com.example.paper.config.security;
...
public class JwtTokenUtils {
    public static final String TOKEN_NAME = "paper_backend";
    ...
    public static String generateToken(UserPO userPODetails) {
        Map<String, Object> claims = new HashMap<>();
        claims.put(CLAIM_KEY_USERNAME, userPODetails.getUsername());
        claims.put(CLAIM_KEY_CREATED, new Date());
        claims.put(CLAIM_KEY_ID, userPODetails.getId());
        claims.put(CLAIM_KEY_ROLES, userPODetails.getAuthorities());
    ...
    public static Boolean validateToken(String token, UserDetails userDetails) {
        ...
        return (
                username.equals(userPO.getUsername())
